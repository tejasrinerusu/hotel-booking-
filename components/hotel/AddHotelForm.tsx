...
import { Divide, Eye, Loader2, Pencil, PencilLine, Plus, Terminal, Trash, XCircle } from "lucide-react";
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormDescription>
                                        Provide detailed description of your hotel
                                    </FormDescription>
                                    <FormControl>
                                        <Textarea placeholder="Beach Hotel is parked with many awesome aminities" {...field} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormDescription>
                                        Provide detailed location description of your hotel
                                    </FormDescription>
                                    <FormControl>
